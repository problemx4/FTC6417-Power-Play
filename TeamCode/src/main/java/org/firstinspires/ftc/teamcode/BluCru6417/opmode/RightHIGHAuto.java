...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "Right High worlds auto")
public class RightHIGHAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.setAutoSlidePower(0.9);
        sleep(500);

        //build trajectory sequences
        TrajectoriesWorlds traj = new TrajectoriesWorlds(true, true);

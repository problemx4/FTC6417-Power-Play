...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(5, 0.3, 0.05);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(7, 0.1, 0.5);

    public static double LATERAL_MULTIPLIER = (60.0 / 31.5) * (60.0 / 59.0);

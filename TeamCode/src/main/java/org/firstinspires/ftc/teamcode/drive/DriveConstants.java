...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(3, 0, 0.15,13.7);
    ...
    public static double GEAR_RATIO = 1 * (60.66 / 59.92); // output (wheel) speed / input (motor) speed
